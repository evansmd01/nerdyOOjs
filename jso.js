...
if (typeof define === 'function' && define.amd) {
    define(function () {
        var jso = {
             ...
             */
            declare: function (declarationObjectLiteral, arrayBaseClasses) {

                var DeclaredClass = function () {
                    //create closures on this.base for invoking overridden functions
                    jso._internal.mapBaseClosures(this);
                ...
                if (arrayBaseClasses instanceof Array && arrayBaseClasses.length > 0) {
                    jso._internal.mapBasePrototypes(DeclaredClass.prototype, arrayBaseClasses);
                }
                ...
                jso._internal.mapDeclaration(DeclaredClass.prototype, declarationObjectLiteral);
